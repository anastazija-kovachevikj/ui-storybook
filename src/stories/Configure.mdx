...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    **Theme customization** (fonts, colors, radius, spacing) lives under **Foundation → Configure → Theme lab**. Toolbar menus for Color, Font, Radius, and Spacing apply the same tokens to every story.

    Storybook also runs separately from your app — use the guides below for stack setup. If you get stuck, ask the Storybook community.
  </div>
